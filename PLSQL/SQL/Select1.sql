...
SET FEEDBACK OFF
SET PAGESIZE 50000
SPOOL V:\Temp\Insert_Into_GFO_ITINERARIO.SQL;
...
SPOOL Off
/
@V:\Temp\Insert_Into_GFO_ITINERARIO.Sql;
Commit;
----------------------------
---  GFO_ITINERARIO_DIA  ---
----------------------------
SPOOL V:\Temp\Insert_Into_GFO_ITINERARIO_DIA.SQL;
...
SPOOL Off
/
@V:\Temp\Insert_Into_GFO_ITINERARIO_DIA.SQL;
Commit;

------------------------------
---  GFO_ITINERARIO_ITENS  ---
------------------------------
SPOOL V:\Temp\Insert_Into_GFO_ITINERARIO_ITENS.SQL;
...
SPOOL Off
/
@V:\Temp\Insert_Into_GFO_ITINERARIO_ITENS.SQL;
Commit;