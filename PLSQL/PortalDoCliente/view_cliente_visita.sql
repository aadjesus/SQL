create or replace view view_cliente_visita as
select 
  ...
  a.dificuldadesencontradas dificuldades, -- Nunca apresentar para o cliente - Grid Principal
  ...
  d.problemadetalhe detalhe,-- Detalhe
